        ...
        <div className='bg-primary w-full sm:w-[550px] p-6 sm:p-10 rounded-xl flex flex-col items-center justify-center'>
          ...
          <form onSubmit={handleSubmit(onSubmit)} className='w-full flex flex-col justify-center'>
            <div className='mt-5'>
              ...
              <input
                className={`px-5 sm:px-14 w-full py-3 sm:py-5 text-sm font-light rounded-lg ${errors.contactInfo ? 'border-red-500' : ''}`}
                type='text'
                id='contactInfo'
            ...
            <div className='mt-5'>
              ...
              <input
                className={`px-5 sm:px-14 w-full py-3 sm:py-5 text-sm font-light rounded-lg ${errors.password ? 'border-red-500' : ''}`}
                type='password'
                id='password'
            ...
            <div className='mt-5 text-center'>
              <p className='text-white font-semibold text-sm sm:p-4 leading-6'>
                Forgot password?
              </p>
