        ...
        <div className="fixed inset-0 bg-black bg-opacity-50 flex justify-center items-center z-50">
          <div className="bg-white p-5 rounded-lg w-3/4 h-3/4 overflow-auto">
            ...
            <p className="text-sm">
              ...
              Welcome to zanmart.com, also hereby known as “we", "us" or "zanmart". We are an online marketplace, and these are the terms and conditions governing your access and use of zanmart along with its related sub-domains, sites, mobile app, services, and tools (the "Site"). By using the Site, you hereby accept these terms and conditions (including the linked information herein) and represent that you agree to comply with these terms and conditions (the "User Agreement"). This User Agreement is deemed effective upon your use of the Site, which signifies your acceptance of these terms. If you do not agree to be bound by this User Agreement, please do not access, register with, or use this Site.
              <br /><br />
              This Site is owned and operated by zanmart Bangladesh Limited, a company incorporated under the Companies Act, 1994, (Registration Number: 117773/14).
              <br /><br />
