  ...
  return (
    <Link href={`/product-details/${item.id}`} className='w-full h-fit rounded-[15px]  shadow-lg '>
      ...
      <div className='p-2'>
        ...
        <p className='flex items-center  justify-between '><span className='text-primary  lg:text-2xl md:xl  font-bold'>{discount_price} <span className='text-xs font-normal text-black'>tk</span></span> <span className='text-secondary text-xs line-through  '> {price} tk</span> <img src="images/shop.svg" alt="" /> </p>
      </div>
    </Link>
