  ...
  return (
    <Link href={`/product-details/${item.product_id}`} className='w-full h-fit rounded-[15px]  shadow-lg '>
      ...
      <div className='p-2'>
        ...
        <p className='flex items-center  justify-between '><span className='text-primary flex  items-center text-sm lg:text-2xl md:xl  font-bold'>{sell_price} <span className='text-xs font-normal text-black'>tk</span></span> <span className='flex text-secondary text-xs line-through  '> 100 tk</span> <Image className='' height={24} width={24} src="/images/shop.svg" alt="cart" /> </p>
      </div>
    </Link>
